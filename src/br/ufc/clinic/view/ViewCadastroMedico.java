...
public class ViewCadastroMedico extends JDialog {
	...
	public static void main(String[] args) {
		try {
			ViewCadastroMedico dialog = new ViewCadastroMedico();
	...
	public ViewCadastroMedico() {
		...
		contentPanel.add(lblEspecialidades);
		{
			...
			for (Especialidade e: especialidades.get()) {
				listEspecialidades.add(e.getNome());
			}
			
			
			
			listEspecialidades.setBounds(8, 199, 156, 72);
		...
		}
		{
			...
			listDiasTrabalha.add(Ferramentas.DiaSemanaToString(DiaSemana.DOMINGO));
			listDiasTrabalha.add(Ferramentas.DiaSemanaToString(DiaSemana.SEGUNDA));
			listDiasTrabalha.add(Ferramentas.DiaSemanaToString(DiaSemana.TERCA));
			listDiasTrabalha.add(Ferramentas.DiaSemanaToString(DiaSemana.QUARTA));
			listDiasTrabalha.add(Ferramentas.DiaSemanaToString(DiaSemana.QUINTA));
			listDiasTrabalha.add(Ferramentas.DiaSemanaToString(DiaSemana.SEXTA));
			listDiasTrabalha.add(Ferramentas.DiaSemanaToString(DiaSemana.SABADO));
			
			
			listDiasTrabalha.setBounds(8, 334, 156, 72);
